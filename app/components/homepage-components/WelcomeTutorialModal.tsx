...
export function WelcomeTutorialModal() {
    ...
    return (
        <div
            className="welcome-backdrop fixed inset-0 z-[120] flex items-center justify-center overflow-y-auto bg-[#140d24]/85 p-3 backdrop-blur-md sm:p-6"
            role="presentation"
        >
            <section
                role="dialog"
                ...
                className="welcome-arena relative grid w-full max-w-[1120px] grid-rows-[285px_540px] overflow-hidden border-[3px] border-[#211530] bg-[#f8ead9] shadow-[0_0_0_3px_#f4c95d,0_24px_80px_rgba(8,3,20,.55)] lg:h-[640px] lg:grid-cols-2 lg:grid-rows-1"
            >
                <button
                    type="button"
                ...
                <div className="relative h-[285px] overflow-hidden border-b-[3px] border-[#211530] lg:h-full lg:border-b-0 lg:border-r-[3px]">
                    <Image
                ...
                <div className="relative flex h-[540px] min-h-0 flex-col overflow-hidden bg-[radial-gradient(circle_at_85%_15%,rgba(167,139,250,.22),transparent_32%),linear-gradient(145deg,#fffaf0,#efddca)] px-5 pb-5 pt-8 sm:px-9 sm:pb-8 sm:pt-10 lg:h-full lg:px-10 lg:pb-10 lg:pt-12">
                    ...
                    <div key={activeSlide} className="welcome-copy my-auto min-h-[250px] py-6 sm:min-h-[290px] sm:py-8 lg:min-h-0">
                        <div className="mb-5 flex h-14 w-14 rotate-3 items-center justify-center border-[3px] border-[#211530] bg-[#f4c95d] text-[#211530] shadow-[4px_4px_0_#211530]">
                            <CurrentIcon className="h-7 w-7" />
                        </div>
                        <p className="text-xs font-black uppercase tracking-[0.2em] text-[#7c3aed]">{currentSlide.eyebrow}</p>
                        <h2 id="welcome-title" className="mt-3 text-4xl font-black leading-[.95] tracking-[-0.04em] text-[#211530] sm:text-5xl">
                            {currentSlide.title}
                        </h2>
                        <p className="mt-5 max-w-[44ch] text-base font-semibold leading-relaxed text-[#3f344b]/85 sm:text-lg">
                    ...
                    <div className="mt-auto">
                        ...
                        <div className="mb-6 h-2 overflow-hidden border border-[#211530] bg-[#fff8ea]">
                            <div
                        ...
                        <p className="mt-4 text-center text-[10px] font-bold uppercase tracking-[0.12em] text-[#211530]/45">
